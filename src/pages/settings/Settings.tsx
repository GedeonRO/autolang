...
export function SettingsPage() {
  ...
  return (
    <DashboardLayout title="Settings">
      <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2 p-5">
            ...
            <div className="space-y-4">
              ...
              >
                <CardHeader className="pb-3">
                  ...
                  <CardDescription className="text-balance max-w-lg leading-relaxed">
                    If you're finished with your session or want to log out for
                    security reasons, you can easily do so. Click the button
                    below to log out of your account.
                  </CardDescription>
                </CardHeader>
                <CardFooter>
                  <AlertLogoutDialog>
